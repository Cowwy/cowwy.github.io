...
//			var techBtn           = document.getElementById( "techBtn" );
			...
			var clsUpgradeScreen  = document.getElementById( "clsUpgradeScreen" );
//			var clsTechScreen     = document.getElementById( "clsTechScreen" );
			var clsStatsScreen    = document.getElementById( "clsStatsScreen" );
			var clsSettingScreen  = document.getElementById( "clsSettingScreen" );
			...
			//VERSION 1.0 - WINDOW CONTROLS
			clsUpgradeScreen.addEventListener( "click", (e) => toggleWindow( "upgradeScreen" ) );
			upgradeBtn.addEventListener( "click", (e) => toggleWindow( "upgradeScreen" ) );

//			clsTechScreen.addEventListener( "click", (e) => toggleWindow( "techScreen" ) );
//			techBtn.addEventListener( "click", (e) => toggleWindow( "techScreen" ) );

			clsStatsScreen.addEventListener( "click", (e) => toggleWindow( "statsScreen" ) );
			statsBtn.addEventListener( "click", (e) => toggleWindow( "statsScreen" ) );

			clsSettingScreen.addEventListener( "click", (e) => toggleWindow( "settingScreen" ) );
