function App_SaveState( ) {
	...
	function saveToLocalStorage( ) {
		...
		var playerState = SessionState.savePlayerState( );

		//Convert Time Object into JSON format
		playerState["GameTime"] = playerState["GameTime"]["seconds"].toJSON( )
		
		saveData[SessionState.saveSlot( )] = playerState;
	...
	function loadFromLocalStorage( ) {
		...
		for( let i = 0; i < keyArray.length; i++ ) {
			...
			//let saveTxt = "Run Time: " + saveDat["GameTime"]["seconds"]["second"];
			let saveTxt = "crap";
